    ...
    <x-slot name="header">
        <div class="flex items-center space-x-3 cursor-pointer group" onclick="window.location='{{ route('patients.index') }}'">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Enter the patient's personal and contact details.</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <form action="{{ route('patients.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="phone" id="phone" value="{{ old('phone') }}" required placeholder="+1234567890"
                                    class="block w-full rounded-xl border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm sm:text-sm transition-colors py-2.5">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email') }}" placeholder="patient@example.com"
                                    class="block w-full rounded-xl border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm sm:text-sm transition-colors py-2.5">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="address" name="address" rows="3"
                                class="block w-full rounded-xl border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm sm:text-sm transition-colors">{{ old('address') }}</textarea>
