                    ...
                    <x-ui.card class="group hover:shadow-md transition-all relative h-full flex flex-col">
                        ...
                        <div class="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between">
                            <div class="flex items-center gap-1.5 w-full justify-center">
                                ...
                                <button class="group relative p-1.5 rounded-md text-gray-400 hover:text-blue-500 hover:bg-gray-50 transition-colors" title="Edit Plan">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </button>
                                
                                <a href="#" class="group relative p-1.5 rounded-md text-gray-400 hover:text-indigo-500 hover:bg-gray-50 transition-colors" title="Continue Treatment">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                </a>
                                
                                <a href="#" class="group relative p-1.5 rounded-md text-gray-400 hover:text-emerald-500 hover:bg-gray-50 transition-colors" title="Add Session">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                </a>
                                
                                <a href="#" class="group relative p-1.5 rounded-md text-gray-400 hover:text-orange-500 hover:bg-gray-50 transition-colors" title="Payment">
